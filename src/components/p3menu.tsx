...
function P3Menu({
  ...
  return (
    <div className="p3menu bg-[#000BB5] w-full h-full flex items-center justify-center px-3 sm:px-6 md:px-10 lg:px-20 relative overflow-hidden">
      {/* MENU */}
